...
ex.maxTimeToWait        = 30;  % Time that a participant has to accept/reject
...
ex.RedCentre    = [1140,225,1440,825];
...
counter = 0 ;
trialTime = GetSecs + ex.maxTimeToWait;
while  GetSecs<trialTime
  ...
  if keyIsDown
    ...
    Screen('FrameRect',scr.w,ex.forceColour,RedCentre); % draw bar
    Screen('FillRect',scr.w,ex.forceColour,[RedCentre(1) RedCentre(2)+600-(counter*1.5) ...
